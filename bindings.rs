...
pub const __the_value: __vcrt_va_list_is_reference__bindgen_ty_1 = 0;
...
pub const k_pch_Perf_LinuxGPUProfiling_Bool: &'static [u8; 18usize] = b"linuxGPUProfiling\0";
...
pub const k_pch_Dashboard_EnableWebUI: &'static [u8; 6usize] = b"webUI\0";
pub const k_pch_Dashboard_EnableWebUIDevTools: &'static [u8; 14usize] = b"webUIDevTools\0";
pub const k_pch_Dashboard_EnableWebUIDashboardReplacement: &'static [u8; 15usize] =
    b"webUIDashboard\0";
...
pub const IVRInput_Version: &'static [u8; 13usize] = b"IVRInput_005\0";
...
pub const ETrackedControllerRole_TrackedControllerRole_Max: ETrackedControllerRole = 4;
...
pub const ETrackedDeviceProperty_Prop_LegacyInputProfile_String: ETrackedDeviceProperty = 7001;
...
pub const EVRButtonId_k_EButton_Knuckles_A: EVRButtonId = 2;
pub const EVRButtonId_k_EButton_Knuckles_B: EVRButtonId = 1;
pub const EVRButtonId_k_EButton_Knuckles_JoyStick: EVRButtonId = 35;
...
pub type EVRApplicationTransitionState = i32;
...
pub type EOverlayDirection = i32;
...
fn bindgen_test_layout_VREvent_Scroll_t() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<VREvent_Scroll_t>())).repeatCount as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(VREvent_Scroll_t),
...
pub struct VR_IVRInput_FnTable {
    ...
    >,
    pub GetPoseActionData: ::std::option::Option<
        unsafe extern "C" fn(
            action: VRActionHandle_t,
            eOrigin: ETrackingUniverseOrigin,
...
fn bindgen_test_layout_VR_IVRInput_FnTable() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<VR_IVRInput_FnTable>())).GetPoseActionData as *const _ as usize
        },
        56usize,
        concat!(
            "Offset of field: ",
